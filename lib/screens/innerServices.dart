...
import 'FormToEmail.dart';

class InnerServices extends StatelessWidget {
  final TitleData;
  final servData;
  InnerServices({
    required  this.TitleData,
    required this.servData });
    
  @override
  Widget build(BuildContext context) {
    fetchServices() async {
     var res= await http.get(Uri.parse("https://samitextile-95531-default-rtdb.firebaseio.com/samiTextileDatabase/ourServices/$servData/data/$TitleData/data.json"));
                     ...
                     return ListView(
                      children: <Widget>[
                        Container(
                          ...
                          height: 50,
                          child: Center(
                            child: Text(TitleData, style: TextStyle(color: Colors.black, fontSize: 25),
                            ),
                          ),
                        ),
                        ListView.builder(
